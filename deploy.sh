...
echo "==> Install sudoers rules (WiFi + power + JACK + mod-ui)..."
...
pistomp ALL=(ALL) NOPASSWD: /bin/systemctl stop mod-ui' | sudo tee /etc/sudoers.d/mod-pi-touch-wifi > /dev/null && sudo chmod 0440 /etc/sudoers.d/mod-pi-touch-wifi"
